...
EquipmentName(String Value),BodyType(None[0], Male[1]/Female[2]),EquipmentType(Both[0], Blademaster[1], Gunner[2]),RarityNumber,DecorationSlots,Defense,MaximumDefense,FireDefense,WaterDefense,ThunderDefense,IceDefense,DragonDefense,Skills(until,,)
